...
public:
	...
	void translate(tml::forest_ext::const_iterator begin, tml::forest_ext::const_iterator end);
	...
	virtual void on_image(const image_params& params, const tml::forest_ext& forest) = 0;
