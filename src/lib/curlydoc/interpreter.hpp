...
public:
	...
	public:
		...
		exception(const std::string& message, const std::string& file, const tml::leaf_ext& leaf);
	};
...
private:
	...
	std::unique_ptr<fsif::file> file; // for including files

public:
	interpreter(std::unique_ptr<fsif::file> file);
	...
	tml::forest_ext eval(const tml::forest_ext& forest, bool preserve_vars = false)
	{
