...
void translator::translate(tml::forest_ext::const_iterator begin, tml::forest_ext::const_iterator end)
{
...
void translator::check_parameter(const tml::tree_ext& tree)
{
	if (tree.children.empty()) {
		throw std::invalid_argument(std::string("no value specified for '") + tree.value.string + "' parameter");
	}
}
