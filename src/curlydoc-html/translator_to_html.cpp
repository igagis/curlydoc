...
void translator_to_html::on_image(const image_params& params, const tml::forest_ext& forest)
{
...
void translator_to_html::on_table(const table& tbl, const tml::forest_ext& forest)
{
	this->ss << '\n' << "<table width=\"100%\">";
